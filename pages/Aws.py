...
st.set_page_config(page_title="AWS CoE Documents Repository", layout="wide")
...
logo_data = get_icon("icons/aws.png")
st.markdown(
    f"""
    <div class='portal-title'>    
        <img src="data:image/png;base64,{logo_data}" style="height:50px; width:50px;">    
        <span>AWS CoE Documents Repository</span>    
    </div>    
    """,
    unsafe_allow_html=True
)

df = pd.read_excel("Aws.xlsx", engine="openpyxl")
