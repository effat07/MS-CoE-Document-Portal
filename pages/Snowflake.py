...
st.set_page_config(page_title="Snowflake CoE Documents Repository", layout="wide")
...
logo_data = get_icon("icons/snowflake.png")
st.markdown(
    f"""
    <div class='portal-title'>    
        <img src="data:image/png;base64,{logo_data}" style="height:80px; width:80px;">    
        <span>Snowflake CoE Documents Repository</span>    
    </div>    
    """,
    unsafe_allow_html=True
)

df = pd.read_excel("Snowflake.xlsx", engine="openpyxl")
